 ...
 * @return {Function}
 */
export function atPos(xFn, yFn, text, font, fillStyle, alpha, strokeStyle, strokeWidth) {
  alpha || (alpha = 1.0);
 ...
 * @return {Function}
 */
export function lowerRight(text, font, fillStyle, alpha, y, strokeStyle, strokeWidth) {
  return atPos(
 ...
 * @return {Function}
 */
export function lowerLeft(text, font, fillStyle, alpha, y, strokeStyle, strokeWidth) {
  return atPos(
    () => 10,
    target => y || (target.height - 10),
    text,
 ...
 * @return {Function}
 */
export function upperRight(text, font, fillStyle, alpha, y, strokeStyle, strokeWidth) {
  return atPos(
    (target, metrics) => target.width - (metrics.width + 10),
    () => y || 20,
    text,
 ...
 * @return {Function}
 */
export function upperLeft(text, font, fillStyle, alpha, y, strokeStyle, strokeWidth) {
  return atPos(
    () => 10,
    () => y || 20,
    text,
 ...
 * @return {Function}
 */
export function center(text, font, fillStyle, alpha, y, strokeStyle, strokeWidth) {
  return atPos(
